...
if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
       ...
       if($fileSize>=200000)
    {
       ...
       echo '<a href="groupdesktop2.php">Back</a>';
        exit();
    }
    ...
    if($record["co"]>=1){
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">Rename your File
        <a href="groupdesktop2.php">Back</a></div>
        ';
        exit();
    }
    ...
    if (move_uploaded_file($fileTmpPath, $destPath)) {
        ...
        $query2="INSERT INTO `group_files` ( `gfile_name`,  `gfile_type`, `gfile_path`,`gfile_size`,`U_ID`,`G_ID`)
